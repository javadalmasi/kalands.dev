...
const initDatepicker = (wrapper) => {
    ...
    const isRange = input.closest('[data-shamsi-datepicker]') !== null;
...
document.addEventListener('DOMContentLoaded', () => {
    document.querySelectorAll('[data-shamsi-datepicker], .shamsi-datepicker-popup').forEach(initDatepicker);
});

window.PersianDate = PersianDate;
window.toGregorianFromShamsi = toGregorianFromShamsi;
