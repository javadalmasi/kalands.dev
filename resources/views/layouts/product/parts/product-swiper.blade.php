    ...
    <div class="mb-6">
        <div>
            <div class="mb-6 flex items-center justify-between border-r-4 border-primary pr-4">
                <div>
                    <h3 class="text-lg font-black text-slate-800 dark:text-white lg:text-xl">کالاهای مرتبط</h3>
            ...
            <div class="swiper product-slider p-px">
                <livewire:product.recommended
                        :cat="$data['data']['product']['breadcrumb'][sizeof($data['data']['product']['breadcrumb'])-2]['title']"
                        lazy/>
...
@if($store == "basalam" && isset($data['navigation']['title']))
    <div class="mb-6">
        <div>
            ...
            <div class="swiper product-slider p-px">
                <livewire:product.recommended
                        :cat="str_replace([',','|'],'',$data['navigation']['title'])"
                        lazy/>
                <div class="swiper-button-next"></div>
                <div class="swiper-button-prev"></div>
            </div>
