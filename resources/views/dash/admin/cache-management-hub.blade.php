                ...
                <div class="admin-card space-y-6">
                    ...
                    <div class="space-y-8 text-sm text-slate leading-7">
                        ...
                        <section id="doc-ttl">
                            ...
                            <p>TTL (Time To Live) زمان نگهداری داده‌ها در کش را مشخص می‌کند. مقدار پیش‌فرض برای Autocomplete ۳۱۵۳۶۰۰۰ ثانیه (یک سال) است.</p>
                            <div class="mt-4 bg-primary/5 border border-primary/20 rounded-xl p-4">
                        ...
                        <section id="doc-custom-headers">
                            <h3 class="text-base font-bold text-slate mb-3 flex items-center gap-2">
                                <span class="material-icons text-primary text-lg">http</span>
                                هدرهای سفارشی
                            </h3>
                            <p>با فعال‌سازی هدرهای سفارشی، می‌توانید مقادیر Cache-Control، X-LiteSpeed-Cache، CDN-Cache-Control و Cloudflare-CDN-Cache را به صورت دلخواه تنظیم کنید.</p>
                        </section>
                    </div>
                </div>
            </div>
            ...
            <aside class="hidden lg:block w-64 shrink-0">
                <div class="admin-card !p-4 sticky top-4">
                    ...
                    <nav class="space-y-1">
                        ...
                        <a href="#doc-custom-headers" class="doc-nav-link block px-3 py-2 rounded-lg text-xs font-medium text-slate hover:bg-primary/5 hover:text-primary transition-colors">هدرهای سفارشی</a>
                    </nav>
                </div>
            </aside>
        </div>
