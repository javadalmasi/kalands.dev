<x-layouts.admin-dashboard title="فایل Robots.txt" :helpModuleKey="'robots'">
    ...
    <x-admin.page-header title="مدیریت Robots.txt" />

    <x-admin.tab-bar id="robots-tabs">
        <button class="admin-tab-btn border-b-2 border-primary text-primary font-bold" data-tab-target="tab-editor">
            <span class="material-icons text-base">edit</span>
            <span>ویرایشگر</span>
        </button>
        <button class="admin-tab-btn" data-tab-target="tab-tester">
                ...
                <div class="admin-card">
                    ...
                    <div class="space-y-4">
                        <div class="space-y-1">
                            ...
                            <div class="relative">
                                <input type="text" id="test-agent" class="admin-ltr admin-input" value="*">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" id="test-path" class="admin-ltr admin-input" value="/" placeholder="/example-path">
                        </div>
