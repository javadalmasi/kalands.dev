<x-layouts.admin-dashboard title="مدیریت صف‌ها">
    ...
    <div class="admin-card mb-6 !p-0 overflow-hidden">
        <div class="flex border-b border-slate dark:border-white/10 overflow-x-auto whitespace-nowrap bg-slate/5" id="queue-tabs">
    ...
    <form id="regenerate-token-form" action="{{ route('dash.admin.queues.token.regenerate', ['authkey' => $authkey]) }}" method="POST" class="hidden">
        @csrf
    </form>
