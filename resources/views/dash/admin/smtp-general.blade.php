<x-layouts.admin-dashboard title="SMTP عمومی">
    ...
    <h1 class="admin-page-title">SMTP عمومی</h1>
    <form action="{{ route('dash.admin.smtp.general.save', ['authkey' => $authkey]) }}" method="POST" class="admin-card grid gap-3 md:grid-cols-2">
        ...
        <div class="md:col-span-2">
            <select name="mailer" class="mailer-select rounded bg-slate p-2 dark:bg-slate-800 dark:text-white dark:border-white/10 dark:focus:bg-slate-700 w-full" data-target="general-smtp-fields">
