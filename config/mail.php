...
return [
    ...
    */
    ...
    'default' => env('TRANSACTIONAL_MAIL_MAILER', 'smtp'),
    ...
    */
    ...
    'mailers' => [
        'smtp' => [
            'transport' => 'smtp',
            'url' => env('TRANSACTIONAL_MAIL_URL'),
            'host' => env('TRANSACTIONAL_MAIL_HOST', env('MAIL_HOST', 'smtp.mailgun.org')),
            'port' => env('TRANSACTIONAL_MAIL_PORT', env('MAIL_PORT', 587)),
            ...
            'timeout' => null,
            'local_domain' => env('TRANSACTIONAL_MAIL_EHLO_DOMAIN', env('MAIL_EHLO_DOMAIN')),
        ],
