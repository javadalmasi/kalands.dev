...
class AdminDashboardController extends Controller
{
    ...
    public function saveCacheManagementSettings(Request $request, SettingsRepository $settingsRepository, ActivityLogger $activityLogger): RedirectResponse
    {
        $data = $request->validate([
            ...
            'autocomplete_custom_cc_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'autocomplete_custom_cc_type' => ['nullable', 'in:public,private'],
            'autocomplete_custom_lsc_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'autocomplete_custom_lsc_type' => ['nullable', 'in:public,private'],
            'autocomplete_custom_cdn_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'autocomplete_custom_cdn_type' => ['nullable', 'in:public,private'],
            'autocomplete_custom_cf_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'autocomplete_custom_cf_type' => ['nullable', 'in:public,private'],
            ...
            'visitor_info_custom_cc_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'visitor_info_custom_cc_type' => ['nullable', 'in:public,private'],
            'visitor_info_custom_lsc_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'visitor_info_custom_lsc_type' => ['nullable', 'in:public,private'],
            'visitor_info_custom_cdn_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'visitor_info_custom_cdn_type' => ['nullable', 'in:public,private'],
            'visitor_info_custom_cf_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'visitor_info_custom_cf_type' => ['nullable', 'in:public,private'],
            ...
            'affiliate_custom_lsc_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'affiliate_custom_lsc_type' => ['nullable', 'in:public,private'],
            'affiliate_custom_cdn_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'affiliate_custom_cdn_type' => ['nullable', 'in:public,private'],
            'affiliate_custom_cf_ttl' => ['nullable', 'integer', 'min:0', 'max:31536000'],
            'affiliate_custom_cf_type' => ['nullable', 'in:public,private'],
        ]);
        ...
        $settingsRepository->set('cache.webservices', [
            ...
            'autocomplete_custom_cc_ttl' => $data['autocomplete_custom_cc_ttl'] ?? null,
            'autocomplete_custom_cc_type' => $data['autocomplete_custom_cc_type'] ?? null,
            'autocomplete_custom_lsc_ttl' => $data['autocomplete_custom_lsc_ttl'] ?? null,
            'autocomplete_custom_lsc_type' => $data['autocomplete_custom_lsc_type'] ?? null,
            'autocomplete_custom_cdn_ttl' => $data['autocomplete_custom_cdn_ttl'] ?? null,
            'autocomplete_custom_cdn_type' => $data['autocomplete_custom_cdn_type'] ?? null,
            'autocomplete_custom_cf_ttl' => $data['autocomplete_custom_cf_ttl'] ?? null,
            'autocomplete_custom_cf_type' => $data['autocomplete_custom_cf_type'] ?? null,
            ...
            'visitor_info_custom_cc_ttl' => $data['visitor_info_custom_cc_ttl'] ?? null,
            'visitor_info_custom_cc_type' => $data['visitor_info_custom_cc_type'] ?? null,
            'visitor_info_custom_lsc_ttl' => $data['visitor_info_custom_lsc_ttl'] ?? null,
            'visitor_info_custom_lsc_type' => $data['visitor_info_custom_lsc_type'] ?? null,
            'visitor_info_custom_cdn_ttl' => $data['visitor_info_custom_cdn_ttl'] ?? null,
            'visitor_info_custom_cdn_type' => $data['visitor_info_custom_cdn_type'] ?? null,
            'visitor_info_custom_cf_ttl' => $data['visitor_info_custom_cf_ttl'] ?? null,
            'visitor_info_custom_cf_type' => $data['visitor_info_custom_cf_type'] ?? null,
            'affiliate_ttl' => (int) $data['affiliate_ttl'],
            'affiliate_litespeed' => (bool) ($data['affiliate_litespeed'] ?? false),
            'affiliate_cache_type' => $data['affiliate_cache_type'],
            'affiliate_custom_enabled' => (bool) ($data['affiliate_custom_enabled'] ?? false),
            'affiliate_custom_cc_ttl' => $data['affiliate_custom_cc_ttl'] ?? null,
            'affiliate_custom_cc_type' => $data['affiliate_custom_cc_type'] ?? null,
            'affiliate_custom_lsc_ttl' => $data['affiliate_custom_lsc_ttl'] ?? null,
            'affiliate_custom_lsc_type' => $data['affiliate_custom_lsc_type'] ?? null,
            'affiliate_custom_cdn_ttl' => $data['affiliate_custom_cdn_ttl'] ?? null,
